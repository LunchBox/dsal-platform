  ...
  <div>
    ...
    <div class="flex gap-x-8">
      ...
      <div class="flex-1 py-4">
        <section class="mb-8">
          <h3 class="border-b py-1">我的成就</h3>
          <ul class="mb-4">
            <li
              ...
              class="py-2 border-b"
            >
              <RouterLink :to="`/jobs?tag=${skill}`" class="flex gap-x-4">
                <div class="w-16 h-16 border grid place-content-center">
                  <Award :size="48" />
                </div>
                <div>
                  #{{ skill }}
